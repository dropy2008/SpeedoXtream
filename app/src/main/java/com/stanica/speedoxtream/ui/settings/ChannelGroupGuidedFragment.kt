...
class ChannelGroupGuidedFragment : GuidedStepSupportFragment() {
    ...
    override fun onCreateActions(actions: MutableList<GuidedAction>, savedInstanceState: Bundle?) {
        val sharedPreferences = requireContext().getSharedPreferences(Constants.SPEEDOXTREAM_PREFERENCES, Context.MODE_PRIVATE)
    ...
    /*
    * @func   onGuidedActionClicked
    * @author stanica
    * @date   04/12/2021
    * @desc   Channel Actions  --- Here are menu for channel group.
    * */
