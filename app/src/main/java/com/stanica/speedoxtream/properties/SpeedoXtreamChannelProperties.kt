...
/**
 * Concrete implementation of [ChannelProperties] for SpeedoXtream.
 *
 * @author stanica
 * @date  11/04/2021
 */
class SpeedoXtreamChannelProperties(sharedPreferences: SharedPreferences) : ChannelProperties {
