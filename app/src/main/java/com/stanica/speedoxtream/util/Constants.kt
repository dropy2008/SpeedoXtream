...
object Constants {
     ...
     */
    val TV_INPUT_SERVICE_COMPONENT = ComponentName("com.stanica.speedoxtream", ProviderTvInputService::class.java.canonicalName)

    // Preferences stuff
    const val SPEEDOXTREAM_PREFERENCES = "SpeedoXtreamSharedPreferences"
